...
const Hero = () => {
  ...
  <div className="hero-content text-center">
    <div className="max-w-ld">
      <h1 className="text-5xl font-bold">Welcome to {' '}<span className="bg-gradient-to-r from-secondary bg-300% via-blue-500 to-green-400 text-transparent bg-clip-text animate-gradient">ByteBlaze</span></h1>
      <p className="py-6">
        ByteBlaze is the bridge between the complex world ot technology and <br /> the curious minds eager to under stand it.
      </p>
